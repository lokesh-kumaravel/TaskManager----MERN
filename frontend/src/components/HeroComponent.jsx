          ...
          <div className="image-column">
            ...
            <div className="image-column-item">
              <div
                style={{
                  ...
                  justifyContent: "center", // Aligns content vertically in the center if height is set
                  textAlign: "center", // Ensures text (like the number) is centered
                }}
              >
                <div className="block-1">
                  <svg
                    ...
                    width="80" // Adjust width of the SVG to suit your design
                    height="80" // Adjust height of the SVG to suit your design
                  >
                    <g fill-rule="nonzero">
            ...
            <div className="image-column-item">
              <div
                style={{
                  display: "flex",
                  flexDirection: "column", // Stacks the SVG and text vertically
              ...
              >
                <div className="block-1">
                  <svg
                    ...
                    width="80" // Adjust the size of the SVG (width and height can be customized)
                    height="80"
                  >
                    <path
                      fill-rule="nonzero"
